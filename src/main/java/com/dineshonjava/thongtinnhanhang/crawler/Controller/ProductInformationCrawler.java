...
public class ProductInformationCrawler extends WebCrawler {
    ...
    private static final String DOMAIN = "https://www.thegioididong.com/";
    private static final Pattern NEWS_PAGE = Pattern.compile(".*/\\w+\\.html");
    private static final Pattern TAGS_PAGES = Pattern.compile(".*thegioididong\\.com\\/(catelogy)\\/(product).*");
